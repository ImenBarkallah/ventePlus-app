package org.ms.reglementsservice.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.disable()).csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/reglements/**").hasAnyRole("USER", "ADMIN") // Modifier selon les r̫les
                        .requestMatchers(HttpMethod.POST, "/reglements/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/reglements/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/reglements/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/reglements/**").hasRole("ADMIN")
